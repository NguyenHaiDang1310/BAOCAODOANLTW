         ...
         <div class="row">
            <div class="col-md-6">
               ...
               <div class="mb-3">
                  ...
                  <input type="text" name="email" id="phone" value="<?= $customer->email; ?>" class="form-control" 
               ...
               <div class="thanhtoan mb-4">
                  ...
                  <div class="p-4 border bankinfo">
                     ...
                     <p>STK: 1029881292</p>
                     <p>Chủ tài khoản: Nguyễn Hải Đăng</p>
                  </div>
               </div>
               <div class="text-end">
               ...
               <table class="table table-borderless">
                  <thead>
                     <tr class="bg-dark">
                        ...
                        <th class="text-center" class='text-center'>Thành tiền</th>
                     </tr>
                  </thead>
                  <tbody>
                     <?php $stt=1; ?>
