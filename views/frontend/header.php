      ...
      <div class="container">
         <div class="row">
            <div class="col-6 col-sm-6 col-md-2 py-1">
               <a href="index.php">
                  <img class="img-fluid" style="width:135px;" src="public/images/logo1.jpg" alt="Logo">
               </a>
            </div>
                  ...
                  <ul class="nav nav-fills py-0 my-0">
                     <li class="nav-item">
                        <a class="nav-link" href="login.html">
                           <i class="fa fa-phone-square bg-main" aria-hidden="true"></i>
                           0372736636
                        </a>
                     </li>
