                     ...
                     <tbody>
                        <?php foreach ($list as $item) : ?>
                           <tr>
                              ...
                              <td class="text-center">
                                 <a href="index.php?option=customer&cat=destroy&id=<?= $item->id; ?>" class="btn btn-sm btn-danger">
                                    <i class="fas fa-trash"></i>
                                 </a>
                                 <a href="index.php?option=customer&cat=restore&id=<?= $item->id; ?>" class="btn btn-sm btn-info">
